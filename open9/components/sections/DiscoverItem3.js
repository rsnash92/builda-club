...
export default function DiscoverItem3() {
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="heading-section pb-30">
                <h2 className="tf-title ">Hot bids</h2>
                <Link href="/explore-3">
                  View all bids <i className="icon-arrow-right2" />
                </Link>
              </div>
            </div>
            ...
            >
              <div className="tf-card-box style-1">
                ...
                <h5 className="name">
                  <Link href={`/product-detail-1`}>Dayco serpentine belt</Link>
                </h5>
