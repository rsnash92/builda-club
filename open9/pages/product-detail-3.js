              ...
              <div className="row">
                <div className="col-12">
                  <div className="infor-product style-1">
                    <div
                      data-wow-delay="0s"
                      className="wow fadeInUp text justify-center"
                    >
                    ...
                    <h2
                      data-wow-delay="0s"
                      className="wow fadeInUp text-center pb-30 mb-0"
                    >
                      Themesflat #0270
                    </h2>
                    <div className="flex items-center justify-between">
                      <div
                        data-wow-delay="0s"
                        className="wow fadeInLeft author flex items-center"
                      >
                        ...
                        <div className="info">
                          <span>Owned by:</span>
                          <h6>
                            <Link href="/author-1">Marvin McKinney</Link>{" "}
                          </h6>
                        </div>
                      </div>
                      ...
                      <div
                        data-wow-delay="0s"
                        className="wow fadeInRight menu_card position-unset"
                      >
                ...
                <div className="col-12">
                  <Swiper
                    {...swiperOptions}
                    className="swiper-container carouselfull-2"
                  >
                    <SwiperSlide>
                      <div className="tf-card-box style-6">
                        <div className="card-media">
                          <Link href="#">
                            <img
                              src="/assets/images/box-item/product-slide-01.jpg"
                              alt=""
                            />
                          </Link>
                        </div>
                    ...
                    <SwiperSlide>
                      <div className="tf-card-box style-6">
                        <div className="card-media">
                          <Link href="#">
                            <img
                              src="/assets/images/box-item/product-slide-02.jpg"
                              alt=""
                            />
                          </Link>
                        </div>
                ...
                <div className="col-12">
                  <div
                    data-wow-delay="0s"
                    className="wow fadeInUp product-item time-sales"
                  >
                    <h6>
                  ...
                  <div
                    data-wow-delay="0s"
                    className="wow fadeInUp product-item description"
                  >
                    <h6>
                    ...
                    <div className="content">
                      <p>
                        ...
                        details are steeped in historical significance. We
                  ...
                  <div
                    data-wow-delay="0s"
                    className="wow fadeInUp product-item history"
                  >
                    <h6>
                      <i className="icon-description" />
                      Price History
                  ...
                  <div
                    data-wow-delay="0s"
                    className="wow fadeInUp product-item traits style-1"
                  >
                    <h6>
                      <i className="icon-description" />
                      Traits
                  ...
                  <div
                    data-wow-delay="0s"
                    className="wow fadeInUp product-item item-activity mb-0"
                  >
                    <h6>
