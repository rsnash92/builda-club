            ...
            <div className="themesflat-container">
              <div className="row">
                <div className="col-md-6">
                  ...
                  >
                    <div className="card-media mb-0">
                      <Link href="#">
                        <img
                          src="/assets/images/box-item/product-01.jpg"
                          alt=""
                        />
                      </Link>
                    </div>
                  ...
                  >
                    <div className="card-media mb-0">
                      <Link href="#">
                        <img
                          src="/assets/images/box-item/product-02.jpg"
                          alt=""
                        />
                      </Link>
                    </div>
                  ...
                  >
                    <div className="card-media mb-0">
                      <Link href="#">
                        <img
                          src="/assets/images/box-item/product-03.jpg"
                          alt=""
                        />
                      </Link>
                    </div>
                ...
                <div className="col-md-6">
                  ...
                  >
                    ...
                    <div className="content">
                      <p>
                        ...
                        envision 8SIAN being a global, inclusive community that
                        brings together members who share admiration for Asian
                        cultures. We want to represent, educate and build a
                        lasting presence in the NFT space.
                      </p>
                    </div>
                  </div>
                  <div
                  ...
                  <div
                    data-wow-delay="0s"
                    className="wow fadeInRight product-item details"
                  >
                    <h6>
                      <i className="icon-description" />
                      Details
                  ...
                  <div
                    data-wow-delay="0s"
                    className="wow fadeInRight product-item traits"
                  >
                    <h6>
                      <i className="icon-description" />
                      Traits
